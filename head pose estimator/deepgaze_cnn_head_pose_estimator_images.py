...
import cv2
from deepgaze_cnn_head_pose_estimator import CnnHeadPoseEstimator
...
file_name = '/Users/leon/Downloads/Biwi Kinect Head Pose Database/hpdb_face_intercepted/{0}/frame_00{1:03d}_rgb.png'.format('12', 23)
